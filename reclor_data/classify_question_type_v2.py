...
if __name__ == "__main__":
    lr_train_file = 'train.json'
    lr_val_file = 'val.json'
    lr_test_file = 'test.json'
    ...
    # calculate_question_type_distribution(all_question_types_test_our)
    ...
    # save question type
    ques_type_train_file = 'train_ques_types'
    ques_type_val_file = 'val_ques_types'
    ques_type_test_file = 'test_ques_types'
